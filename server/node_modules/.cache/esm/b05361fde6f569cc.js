let express,mysql,multer,path,cors,fileURLToPath;_e6f‍.w("express",[["default",["express"],function(v){express=v}]]);_e6f‍.w("mysql",[["default",["mysql"],function(v){mysql=v}]]);_e6f‍.w("multer",[["default",["multer"],function(v){multer=v}]]);_e6f‍.w("path",[["default",["path"],function(v){path=v}]]);_e6f‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_e6f‍.w("url",[["fileURLToPath",["fileURLToPath"],function(v){fileURLToPath=v}]]);
...
db.connect((err) => {
    if (err) {
        _e6f‍.g.console.error('Error connecting to database:', err);
        return;
    }
...
app.post('/entrepriseform', upload.single('cover'), async (req, res) => {
    try {
        ...
        _e6f‍.g.console.error('Error adding entreprise:', error);
